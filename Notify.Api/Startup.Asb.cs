...
namespace Notify.Api
{
    public partial class Startup
    {
        ...
        private void RegisterEventBus(IServiceCollection services)
        {
            ...
            services.AddTransient<CustomerAccountActivationHandler>();
            services.AddTransient<UserCreatedEventHandler>();
            services.AddTransient<BookingCompletedEventHandler>();
            services.AddTransient<PaymentSuccededEventHandler>();
            services.AddTransient<BookingCancelledEventHandler>();
            services.AddTransient<PasswordResetEventHandler>();
        }
    }
}