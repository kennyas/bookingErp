...
{
    public class AuthDbContext : IdentityDbContext<GigmUser, GigmRole, Guid, GigmUserClaim, GigmUserRole, GigmUserLogin, GigmRoleClaim, GigmUserToken>, IDbContext
    {
        ...
        private static MethodInfo ConfigureGlobalFiltersMethodInfo =
            typeof(AuthDbContext).GetMethod(nameof(ConfigureGlobalFilters), BindingFlags.Instance | BindingFlags.NonPublic);
