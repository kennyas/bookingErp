    ...
    public static class RDFacadeExtensions
    {
        ...
        public static RelationalDataReader ExecuteSqlQuery(this DatabaseFacade databaseFacade, string sql, params object[] parameters)
        {
            ...
            using (concurrencyDetector.EnterCriticalSection())
            {
                ...
                var command = new RelationalCommandParameterObject
                    (databaseFacade.GetService<IRelationalConnection>(),
                                    parameterValues: rawSqlCommand.ParameterValues, null, null);
                                                             ...
                                                             params object[] parameters)
        {
            ...
            using (concurrencyDetector.EnterCriticalSection())
            {
                ...
                var command = new RelationalCommandParameterObject
                    (databaseFacade.GetService<IRelationalConnection>(), parameterValues: rawSqlCommand.ParameterValues, null, null);
